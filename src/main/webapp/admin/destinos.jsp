<%-- 
    Document   : Destinos
    Created on : sep 29, 2021, 1:54:23 a.m.
    Author     : Robert
--%>
    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 250px; background: linear-gradient(180deg, rgba(0,164,215,1) 0%, rgba(9,91,165,1) 100%);">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="../admin/destinos.jsp" class="nav-link active" aria-current="page">
        ...
        <div class="w-100 p-3" style="background-color: #ffffff;">   
            <div class="min-vh-100">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="#victorModal" role="button" class="btn btn-large btn-primary" data-toggle="modal">Agregar Destino</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">            
                                    <h4 class="modal-title">Nuevo Destino <span class="float-left"></span> </h4>
                                ...
                                <div style="margin:35px;">
                                    <form>
                                        <div class="row mb-3">
                                            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Ciudad</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" placeholder="" aria-label="default input example">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="exampleFormControlInput1" class="col-sm-3 col-form-label">Aeropuerto</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" placeholder="" aria-label="default input example">
                                            </div>
                                        </div> 
